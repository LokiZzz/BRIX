...
namespace BRIX.Library.Effects.HealDamage
{
    public class ObstacleAspect : AspectBase
    {
        ...
        {
            return ObstacleEquivalentToPercentMap[BetweenCharacterAndTargetOrArea].ToNegativeCoeficient()
                * ObstacleEquivalentToPercentMap[BetweenEpicenterAndTarget].ToNegativeCoeficient()
                * ObstacleEquivalentToPercentMap[ObstacleBetweenTargetsInChain].ToNegativeCoeficient();
        }
    }
